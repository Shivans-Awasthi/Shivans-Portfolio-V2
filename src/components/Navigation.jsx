...
<div class="navbar fixed relative top-0 z-10 glass bg-base-800 w-full">
  ...
  <div data-aos="fade-down" data-aos-duration="500"   data-aos-delay="0">
    ...
    <div class="dropdown">
      ...
      <ul tabindex="0" class="menu glass bg-gray-800 text-white menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
