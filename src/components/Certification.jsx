...
<div class="card card-compact w-96 bg-neutral shadow-xl">
  ...
  <div class="card-body">
    <h2 class="card-title text-neutral-content">Data Structures Course // Coursera</h2>
...
<div class="card card-compact w-96 bg-neutral shadow-xl">
  ...
  <div class="card-body">
    <h2 class="card-title text-neutral-content">Programming Foundations with JavaScript, HTML and CSS Course // Coursera</h2>
