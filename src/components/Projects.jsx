...
<div class="card w-96 bg-neutral text-neutral-content">
  ...
  <div class="card-body">
    ...
    <div class="card-actions">
      ...
      <button class="btn btn-primary">Deployment</button><button class="btn btn-dark"><ion-icon name="logo-github"></ion-icon>Open on Github</button>
    </div>
  </div>
</div>
</div>
...
<div class="card w-96 bg-neutral text-neutral-content">
  <div class="card-body">
    ...
    <div class="card-actions">
      <button class="btn btn-dark"><ion-icon name="logo-github"></ion-icon>Open on Github</button>
    </div>
  </div>
</div>
</div>
