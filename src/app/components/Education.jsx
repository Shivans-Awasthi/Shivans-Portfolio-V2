...
<h1 class="text-md text-white text-left rainbow-text p-2 rounded-md">Cultivating a lifelong love of learning through academic excellence and intellectual curiosity.</h1>
...
<ul class="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical text-white">
  <li>
    ...
    <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="200"><div class="text-md text-warning">B.Tech Computer Science and System Engineering</div>
  ...
  <li>
    ...
    <div data-aos="fade-left" data-aos-duration="500" data-aos-delay="300"><h1 class="text-md text-warning">Class XII- Higher Secondary Education(CBSE)</h1>
