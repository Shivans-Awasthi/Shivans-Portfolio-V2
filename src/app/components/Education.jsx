...
<h1 class="text-5xl font-bold text-center text-black">Education</h1>
...
<ul class="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical text-black ">
  <li>
    ...
    <div data-aos="fade-right" data-aos-duration="500" data-aos-delay="300"><div class=" myname text-blue-800">B.Tech Computer Science and System Engineering</div>
  ...
  <li>
    ...
    <div data-aos="fade-left" data-aos-duration="500" data-aos-delay="300"><h1 class="text-md myname text-blue-800">Class XII- Higher Secondary Education(CBSE)</h1>
