...
<h1 class=" text-black text-left border-b-4 shadow-xl border-black p-2">Cultivating a lifelong love of learning through academic excellence and intellectual curiosity.</h1>
...
<ul class="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical text-black ">
  ...
  <li>
    ...
    <div data-aos="fade-left" data-aos-duration="500" data-aos-delay="300"><h1 class="text-md myname text-black">Class XII- Higher Secondary Education(CBSE)</h1>
