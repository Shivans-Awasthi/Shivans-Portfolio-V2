...
<div class="hero min-h-screen ">
  ...
  <div class="hero-content flex-col lg:flex-row-reverse w-full">
    ...
    <div data-aos="fade-right" data-aos-duration="1000" data-aos-delay="200">
      ...
      <h1 class=" border-b-4 shadow-xl border-white text-left text-black p-4">Lets get connected, and start our next project with enthusiasm and a positive mindset.<br/> Contact me here, or reach out to me on my socials below!</h1>
