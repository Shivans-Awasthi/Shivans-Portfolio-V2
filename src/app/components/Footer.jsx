...
<footer class="footer p-10 bg-white w-full text-black font-bold">
  ...
  <nav>
    ...
    <button class="btn rounded-full border-2  bg-pink-600 text-black btn-square">
    <ion-icon name="logo-instagram" class="h-6 w-6"></ion-icon>
    </button>
    </a>

    <a href="https://twitter.com/ShivansAwasthi">
    <button class="btn rounded-full bg-black border-2  text-black btn-square">
    ...
    <button class="btn rounded-full btn-square border-2  bg-blue-800 text-black text-black">
    <ion-icon name="logo-linkedin" class="h-6 w-6"></ion-icon>
    </button>
    </a>

    <a href="https://github.com/Shivans-Awasthi" >
    <button class="btn rounded-full bg-gray-700 border-2 text-black btn-square">
