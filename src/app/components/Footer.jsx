...
<footer class="footer p-10 glass1 w-full text-base-content text-white">
  ...
  <nav>
    ...
    <button class="btn rounded-none bg-pink-600 text-white btn-square">
    <ion-icon name="logo-instagram" class="h-6 w-6"></ion-icon>
    </button>
    </a>

    <a href="https://twitter.com/ShivansAwasthi">
    <button class="btn rounded-none bg-black text-white btn-square">
    ...
    <button class="btn rounded-none btn-square bg-blue-800 text-white text-white">
    <ion-icon name="logo-linkedin" class="h-6 w-6"></ion-icon>
    </button>
    </a>

    <a href="https://github.com/Shivans-Awasthi" >
    <button class="btn rounded-none bg-gray-700 text-white btn-square">
