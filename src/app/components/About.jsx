...
<div data-aos="fade-down" data-aos-duration="1000"  data-aos-delay="1000">
    <div class="rounded-xl p-5 lg:p-10 bg-neutral-800">  
    
    <h1 class="text-5xl font-bold text-center text-white"><ion-icon name="person"></ion-icon> About Me</h1>

<div class="bg-neutral-800 border-neutral-800 collapse border collapse-arrow">
  <input type="checkbox" class="peer" />
  <div class="collapse-title bg-neutral-800 text-white peer-checked:bg-secondary peer-checked:text-white">
...
👋 Hello! I'm Shivans Awasthi, a passionate and dedicated Full Stack Software Engineer 🚀, specializing in the MERN Stack 💻, .NET Development 🏗️, and Data Science 📊. With a strong foundation in computer science and an insatiable curiosity for technology, I thrive on solving complex problems 🧩 and transforming innovative ideas into impactful solutions.
  ...
  <div class="collapse-content  bg-neutral-800 text-white peer-checked:bg-secondary peer-checked:text-white">
<p class="text-white">  
