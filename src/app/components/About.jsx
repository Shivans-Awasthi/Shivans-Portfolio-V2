...
<div class="bg-zinc-800 border-zinc-800 collapse border collapse-arrow">
  <input type="checkbox" class="peer" />
  <div class="collapse-title bg-zinc-800 text-white peer-checked:bg-secondary peer-checked:text-white">
