...
<div class="hero py-36 min-h-screen w-full ">
  <div class="hero-content w-full">
    ...
    <h1 class="text-2xl font-bold myname text-left text-black">Certificates</h1>
    <h1 class=" text-left border-b-2 shadow-xl border-glass text-black p-2">Certified Proficiencies that Validate My Expertise and Capabilities.</h1>
    </div>
<br/><br/>
...
<div class="card glass1 rounded-none card-compact lg:w-80 sm:w-96 shadow-xl ">
  ...
  <div class="card-body">
    ...
    <div class="card-actions justify-end">
      <button class="btn btn-outline bg-gray-200 text-black  hover:bg-black hover:text-white rounded-none" disabled>View Certificate</button>
    </div>
  </div>
</div>
...
<div class="card glass1 rounded-none card-compact lg:w-80 sm:w-96 shadow-xl">
  ...
  <div class="card-body">
    ...
    <div class="card-actions justify-end">
      <a href="https://coursera.org/share/f9ed8ecee2fd7acf64c4e18be240883c"><button class="btn btn-outline bg-gray-200 text-black  hover:bg-black hover:text-white rounded-none">View Certificate</button></a>
    </div>
  </div>
</div>
</div>
...
<div class="card glass1 rounded-none card-compact lg:w-80 sm:w-96 shadow-xl">
  ...
  <div class="card-body">
    ...
    <div class="card-actions justify-end">
      <a href="https://coursera.org/share/fcbaec57aaf8e88fe18a1a3ae7722ec5"><button class="btn btn-outline bg-gray-200 text-black  hover:bg-black hover:text-white rounded-none">View Certificate</button></a>
    </div>
  </div>
</div>
</div>
...
<div class="card glass1 rounded-none card-compact lg:w-80 sm:w-96 shadow-xl ">
  ...
  <div class="card-body">
    ...
    <div class="card-actions justify-end">
      <a href="https://www.udemy.com/certificate/UC-0b588aa1-970c-42f5-abbb-b9f4e7687001/"><button class="btn btn-outline bg-gray-200 text-black  hover:bg-black hover:text-white rounded-none">View Certificate</button></a>
    </div>
  </div>
</div>
</div>
