...
<div class="hero gradbgpurple py-36 min-h-screen w-full ">
...
<div class="card glassgreen border-8 border-white shadow rounded-lg card-compact lg:w-80 sm:w-96 shadow-xl ">
