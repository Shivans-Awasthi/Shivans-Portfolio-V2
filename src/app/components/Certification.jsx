...
<div class="card bg-neutral shadow rounded-lg card-compact lg:w-80 sm:w-96  ">
  ...
  <div class="card-body">
    ...
    <p class="text-black badge badge-warning rounded-lg">Dr. Angela Yu</p>
    <div class="card-actions justify-end pt-6">
      <button class="btn btn-primary text-white" disabled>View Certificate</button>
    </div>
  </div>
</div>
...
<div class="card bg-neutral  shadow rounded-lg card-compact lg:w-80 sm:w-96 ">
  ...
  <div class="card-body">
    ...
    <p class="text-black badge badge-warning rounded-lg">University of California San Diego</p>
    <div class="card-actions justify-end pt-6">
      <a href="https://coursera.org/share/f9ed8ecee2fd7acf64c4e18be240883c"><button class="btn btn-primary text-white">View Certificate</button></a>
    </div>
  </div>
</div>
</div>
...
<div class="card bg-neutral  shadow rounded-lg card-compact lg:w-80 sm:w-96 ">
  ...
  <div class="card-body">
    ...
    <p class="text-black badge badge-warning rounded-lg">Duke University</p>
    <div class="card-actions justify-end pt-6">
      <a href="https://coursera.org/share/fcbaec57aaf8e88fe18a1a3ae7722ec5"><button class="btn btn-primary text-white">View Certificate</button></a>
    </div>
  </div>
</div>
</div>
...
<div class="card bg-neutral  shadow rounded-lg card-compact lg:w-80 sm:w-96  ">
  ...
  <div class="card-body">
    ...
    <p class="text-black badge badge-warning rounded-lg">Raymond Andrade</p>
    <div class="card-actions justify-end pt-6">
      <a href="https://www.udemy.com/certificate/UC-0b588aa1-970c-42f5-abbb-b9f4e7687001/"><button class="btn btn-primary text-white">View Certificate</button></a>
    </div>
  </div>
</div>
</div>
