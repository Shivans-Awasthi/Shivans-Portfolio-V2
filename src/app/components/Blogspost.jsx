...
<div class="card bg-zinc-800 shadow rounded-lg card-compact lg:w-80 sm:w-96 ">
  ...
  <div class="card-body">
    ...
    <p class="text-black badge badge-secondary rounded-xl">Blogger</p>
    <div class="card-actions justify-end pt-6"> 
      <a href="https://shivansawasthi.blogspot.com/2024/04/essential-requisite-qualities-of-officer.html"><button class="btn bg-zinc-700 border-none text-white hover:bg-zinc-500 hover:text-white">Open Blog<ion-icon name="open"></ion-icon></button></a>
    </div>
  </div>
</div>
</div>
