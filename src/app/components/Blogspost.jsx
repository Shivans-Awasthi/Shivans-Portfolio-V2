...
<div class="hero min-h-screen w-full">
  <div class="hero-content">
    ...
    <h1 class="text-3xl font-bold myname text-center text-black">Blog Spot</h1>
    <h1 class=" text-center text-black p-2">Blogs to Inspire and Inform.</h1>
    <br/>
    </div>
<br/><br/>
...
<div class="card bg-white border border-blue-800 rounded-xl card-compact lg:w-80 sm:w-96 00 ">
