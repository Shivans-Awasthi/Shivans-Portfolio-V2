...
<div class="glowing-sphere"></div>
  <div class="hero-content">
    ...
    <h1 class="text-3xl font-extrabold text-left text-white">Blog Spot</h1>
    <h1 class="text-md text-left border-b shadow-xl border-info text-white p-2">Blogs to Inspire and Inform.</h1>
    <br/>
    </div>
<br/><br/>
...
<div class="card ring-2 ring-gray-500 ring-offset-base-100 ring-offset-2 glass1 rounded card-compact lg:w-80 sm:w-96 00 shadow-xl ">
  ...
  <div class="card-body">
    ...
    <div class="card-actions justify-end">
      <a href="https://shivansawasthi.blogspot.com/2024/04/essential-requisite-qualities-of-officer.html"><button class="btn rounded btn-primary text-white">Open Blog</button></a>
    </div>
  </div>
</div>
</div>
