...
<div class="card glass1 rounded-none card-compact lg:w-80 sm:w-96 00 shadow-xl ">
  ...
  <div class="card-body">
    ...
    <div class="card-actions justify-end"> 
      <a href="https://shivansawasthi.blogspot.com/2024/04/essential-requisite-qualities-of-officer.html"><button class="btn btn-outline bg-gray-200 text-black  hover:bg-black hover:text-white rounded-none">Open Blog</button></a>
    </div>
  </div>
</div>
</div>
