...
<div class="hero min-h-screen w-full">
  <div class="hero-content">
    ...
    <h1 class="text-md text-left rainbow-text text-white p-2 rounded-full">Blogs to Inspire and Inform.</h1>
    <br/>
    </div>
<br/><br/>
...
<div class="card bg-neutral rounded-xl card-compact lg:w-80 sm:w-96 00 shadow-xl ">
  ...
  <div class="card-body ">
    ...
    <div class="card-actions justify-end">
      <a href="https://shivansawasthi.blogspot.com/2024/04/essential-requisite-qualities-of-officer.html"><button class="btn rounded-xl border-2 bg-blue-700 text-white">Open Blog</button></a>
    </div>
  </div>
</div>
</div>
