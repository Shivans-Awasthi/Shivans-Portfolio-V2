...
<div class="hero min-h-screen">
  ...
  <div class="hero-content">
    ...
    <h1 class="text-md text-left border-b-4 rounded shadow-xl border-info text-white p-2">Showcasing My Passion for Problem-Solving and Design Excellence.</h1>
    <br/>
    </div>
<br/><br/>
...
<div class="card rounded-xl lg:w-80 sm:w-96 bg-neutral-800 text-neutral-content text-white">
  <div class="card-body">
    ...
    <div class="card-actions text-warning w-full justify-end">
      ...
      <div class="badge badge-outline rounded-none">React JS</div>
      <div class="badge badge-outline rounded-none">Next JS</div>
      <div class="badge badge-outline rounded-none">Javascript</div>
      <br/><br/>
    </div>
    <div class="card-actions justify-end">
      
      <button class="btn bg-blue-700 text-white rounded-xl border-2">Deployment</button> 
      <a href="https://github.com/Shivans-Awasthi/Shivans-Portfolio-V2"><button class="btn btn-dark text-white rounded-xl border-2"><ion-icon name="logo-github"></ion-icon>Github</button></a>
    </div>
  </div>
</div>
</div>
...
<div class="card rounded-xl bg-neutral-800 lg:w-80 sm:w-96 text-neutral-content text-white">
  <div class="card-body">
    ...
    <div class="card-actions w-full text-warning justify-end">
      ...
      <div class="badge badge-outline rounded-none">TF-IDF</div>
      <div class="badge badge-outline rounded-none">Cosine Similarity</div>
      <div class="badge badge-outline rounded-none">Page Rank</div>
      <div class="badge badge-outline rounded-none">Cloud Deployment</div>
      <br/><br/>
    </div>
    <div class="card-actions justify-end">
      {/* <a href="https://querylinker-web-app-querylinker.koyeb.app/"><button class="btn bg-blue-700 text-white ">Deployment</button></a> */}
      <a href="https://github.com/Shivans-Awasthi/QueryLinker"><button class="btn btn-dark text-white rounded-xl border-2"><ion-icon name="logo-github"></ion-icon>Github</button></a>
    </div>
  </div>
</div>
</div>
...
<div class="card  lg:w-80 sm:w-96 rounded-xl bg-neutral-800 text-neutral-content text-white">
  <div class="card-body">
    ...
    <div class="card-actions w-full text-warning justify-end">
      ...
      <div class="badge badge-outline rounded-none">Transformers</div>
      <br/><br/>
    </div>
    <div class="card-actions justify-end">
      <a href="https://github.com/Shivans-Awasthi/ChatSummation-Text-Summarization-of-conversational-data-using-google-Pegasus-model"><button class="btn rounded-xl border-2 btn-dark text-white"><ion-icon name="logo-github"></ion-icon>Github</button></a>
    </div>
  </div>
</div>
</div>
...
<div class="card rounded-xl lg:w-80 sm:w-96 bg-neutral-800 text-neutral-content text-white">
  <div class="card-body">
    ...
    <div class="card-actions w-fit text-warning justify-end">
      ...
      <div class="badge badge-outline rounded-none">Python</div>
      <div class="badge badge-outline rounded-none">OpenCV</div>
      <div class="badge badge-outline rounded-none">Google API</div>
      <br/><br/>
    </div>
    <div class="card-actions justify-end">
     <a href="https://github.com/Shivans-Awasthi/College-Automation-using-IOT"><button class="btn rounded-xl border-2 btn-dark text-white"><ion-icon name="logo-github"></ion-icon>Github</button></a>
    </div>
  </div>
</div>
</div>
...
<div class="card lg:w-80 sm:w-96 rounded-xl bg-neutral-800 text-neutral-content text-white">
  <div class="card-body">
    ...
    <div class="card-actions text-warning justify-end">
      ...
      <div class="badge badge-outline rounded-none">Wordcloud</div>
      <div class="badge badge-outline rounded-none">Numpy</div>
      <div class="badge badge-outline rounded-none">Pandas</div>
      <div class="badge badge-outline rounded-none">Matplotlib</div>
      <br/><br/>
    </div>
    <div class="card-actions justify-end">
      
      <a href="https://github.com/Shivans-Awasthi/Twitter-Sentiment-Analysis-using-TextBlob"><button class="btn rounded-xl border-2 btn-dark text-white"><ion-icon name="logo-github"></ion-icon>Github</button></a>
    </div>
  </div>
</div>
