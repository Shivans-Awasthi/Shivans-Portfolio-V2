...
<div class="card rounded-none md:w-fit bg-neutral lg:w-80 text-neutral-content text-white">
  <div class="card-body">
    ...
    <div class="card-actions justify-end">
      ...
      <button class="btn bg-blue-700 text-white rounded-none">Deployment</button> 
      <a href="https://github.com/Shivans-Awasthi/Shivans-Portfolio-V2"><button class="btn btn-dark rounded-none text-white"><ion-icon name="logo-github"></ion-icon>Github</button></a>
    </div>
  </div>
</div>
</div>
...
<div class="card rounded-none bg-neutral md:w-fit lg:w-80 text-neutral-content text-white">
  <div class="card-body">
    ...
    <div class="card-actions justify-end">
      ...
      <a href="https://github.com/Shivans-Awasthi/QueryLinker"><button class="btn btn-dark rounded-none text-white"><ion-icon name="logo-github"></ion-icon>Github</button></a>
    </div>
  </div>
</div>
</div>
...
<div class="card  md:w-fit rounded-none lg:w-80 bg-neutral text-neutral-content text-white">
  <div class="card-body">
    ...
    <div class="card-actions justify-end">
      <a href="https://github.com/Shivans-Awasthi/ChatSummation-Text-Summarization-of-conversational-data-using-google-Pegasus-model"><button class="btn rounded-none btn-dark text-white"><ion-icon name="logo-github"></ion-icon>Github</button></a>
    </div>
  </div>
</div>
</div>
...
<div class="card rounded-none md:w-fit bg-neutral lg:w-80 text-neutral-content text-white">
  <div class="card-body">
    ...
    <div class="card-actions justify-end">
     <a href="https://github.com/Shivans-Awasthi/College-Automation-using-IOT"><button class="btn rounded-none btn-dark text-white"><ion-icon name="logo-github"></ion-icon>Github</button></a>
    </div>
  </div>
</div>
</div>
...
<div class="card md:w-fit rounded-none lg:w-80 bg-neutral text-neutral-content text-white">
  <div class="card-body">
    ...
    <div class="card-actions justify-end">
      ...
      <a href="https://github.com/Shivans-Awasthi/Twitter-Sentiment-Analysis-using-TextBlob"><button class="btn rounded-none btn-dark text-white"><ion-icon name="logo-github"></ion-icon>Github</button></a>
    </div>
  </div>
</div>
