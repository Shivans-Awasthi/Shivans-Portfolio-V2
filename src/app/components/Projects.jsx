...
<div class="hero min-h-screen">
  <div class="hero-content">
    ...
    <h1 class="text-3xl text-black myname text-center">Projects</h1>
    <h1 class="text-black text-center">Showcasing My Passion for Problem-Solving and Design Excellence.</h1>
    <br/>
    </div>
<br/><br/>
