...
<div class="bg bg2 bg3"></div>
  ...
  <div class="hero-content text-center min-w-full z-10">
    ...
    <div data-aos="fade-up" data-aos-duration="2000" data-aos-delay="100">
      <h1 class="text-xl text-white text-center">Hello there, I am</h1> <span class="text-center text-3xl font-extrabold text-white"><h1 className="rainbow-text p-2 rounded-md">Shivans Awasthi.</h1></span>
      <br/>
      </div>
